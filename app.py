...
class InputModel(BaseModel):
    ...
    bedrooms: int = Field(2, description="🛏️ Number of bedrooms")
    bathrooms: int = Field(1, description="🛁 Number of bathrooms")
    stories: int = Field(1, description="🏢 Number of stories")
    mainroad: str = Field('no', description="🛣️ Is the house on the main road")
    guestroom: str = Field('no', description="🛋️ Does the house have a guest room")
    basement: str = Field('no', description="🏚️ Does the house have a basement")
    hotwaterheating: str = Field('no', description="🔥 Does the house have hot water heating")
    airconditioning: str = Field('no', description="❄️ Does the house have air conditioning")
    ...
    furnishingstatus: str = Field('furnished', description="🛋️ Furnishing status of the house")
